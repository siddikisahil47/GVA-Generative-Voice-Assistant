...
class AssistantP:
    ...
    def run(self, save_foldername, keyword ='hey', useEL = True, usewhisper = True, timeout = 5):
        '''
        ...
        while True:
            ...
            self.chatGPT.generate_voice("I'm listening.", usewhisper)
            ...
            while True:
                ...
                try:
                    ...
                    save_onprogress(self.chatGPT.messages, suffix=suffix, save_foldername=save_foldername)
                    start_time = time.time()
